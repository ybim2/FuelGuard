# Fuel Guard Quick Log — Connect IQ Store listing
...
Log fuelling and hydration from your Garmin in seconds.
...
Optional Garmin health-pattern sharing is off by default and can be enabled or cleared from the app settings. Availability of individual metrics varies by device.
...
- Optional, disabled-by-default Garmin health-pattern sharing
