...
4. Run `scripts/build-garmin-beta-release.sh` and upload the exported 0.4.2 Quick Log IQ package and the existing Activity Logger IQ package as new versions of their existing beta listings.
