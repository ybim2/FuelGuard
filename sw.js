const APP_VERSION = "mobile-pwa-v101-coach-auth-flow";
const BUILD_VERSION = "2026-08-07T21:30:00Z";
const CACHE_PREFIX = "fuel-guard-";
const CACHE_NAME = "fuel-guard-mobile-pwa-v101-coach-auth-flow-20260807T213000Z";
const APP_SHELL = [
  "./",
  "./index.html",
  "./coach/index.html",
