const APP_VERSION = "mobile-pwa-v106-coach-review-domain";
const BUILD_VERSION = "2026-08-07T17:40:31Z";
const CACHE_PREFIX = "fuel-guard-";
const CACHE_NAME = "fuel-guard-mobile-pwa-v106-coach-review-domain-20260807T174031Z";
const APP_SHELL = [
  "./",
  "./index.html",
  "./coach/index.html",
