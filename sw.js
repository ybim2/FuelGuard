const APP_VERSION = "mobile-pwa-v135-reflection-ux";
const BUILD_VERSION = "2026-08-11T11:46:00Z";
const CACHE_PREFIX = "fuel-guard-";
const CACHE_NAME = "fuel-guard-mobile-pwa-v135-reflection-ux-20260811T114600Z";
const APP_SHELL = [
  "./",
  "./index.html",
  "./coach/index.html",
